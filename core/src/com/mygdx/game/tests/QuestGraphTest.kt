...
import com.mygdx.game.quest.QuestTaskDependency
import java.util.*

object QuestGraphTest {
    var _questTasks: Hashtable<String, QuestTask>? = null
    var _graph: QuestGraph? = null
    var _json: Json? = null
    var quit = "q"
    var _input = ""
    ...
    fun main(arg: Array<String>) {
        ...
        _questTasks!![firstTask.id] = firstTask
        _questTasks!![secondTask.id] = secondTask
        _graph = QuestGraph()
        ...
        _questTasks!![q1.id] = q1
        _questTasks!![q2.id] = q2
        _questTasks!![q3.id] = q3
        _questTasks!![q4.id] = q4
        _graph!!.setTasks(_questTasks!!)
        ...
        println(_json!!.prettyPrint(_graph))
        _questTasks!!.clear()
        _graph!!.clear()
        val q01 = QuestTask()
        q01.id = "1"
        ...
        _questTasks!![q01.id] = q01
        _questTasks!![q02.id] = q02
        _graph!!.setTasks(_questTasks!!)
